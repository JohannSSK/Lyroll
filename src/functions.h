...
// GUI
void MakeWindowRealTime(int count, long int* milli, char lyric[MAX_LINES][MAX_LINE_LEN], char* font, char* length);
void MakeWindowStatic(int count,long int* milli, char lyric[MAX_LINES][MAX_LINE_LEN], char* font, char* length);
